...
export const getGetLabExerciseQueryOptions = <TData = Awaited<ReturnType<typeof getLabExercise>>, TError = ErrorType<ErrorEnvelope | void>>(id: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getLabExercise>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export type GetLabExerciseQueryError = ErrorType<ErrorEnvelope | void>
...
export function useGetLabExercise<TData = Awaited<ReturnType<typeof getLabExercise>>, TError = ErrorType<ErrorEnvelope | void>>(
...
export const getDeleteLabExerciseUrl = (id: string,) => {
 ...
 */
export const deleteLabExercise = async (id: string, options?: Parameters<typeof customFetch>[1]): Promise<void> => {

  return customFetch<void>(getDeleteLabExerciseUrl(id),
  {
    ...options,
    method: 'DELETE'
...
export const getDeleteLabExerciseMutationOptions = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteLabExercise>>, TError,{id: string}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof deleteLabExercise>>, TError,{id: string}, TContext> => {

const mutationKey = ['deleteLabExercise'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteLabExercise>>, {id: string}> = (props) => {
          const {id} = props ?? {};

          return  deleteLabExercise(id,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteLabExerciseMutationResult = NonNullable<Awaited<ReturnType<typeof deleteLabExercise>>>

    export type DeleteLabExerciseMutationError = ErrorType<ErrorEnvelope>

    /**
 * @summary Delete one owned laboratory exercise and its attempts
 */
export const useDeleteLabExercise = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteLabExercise>>, TError,{id: string}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof deleteLabExercise>>,
        TError,
        {id: string},
        TContext
      > => {
      return useMutation(getDeleteLabExerciseMutationOptions(options));
    }
