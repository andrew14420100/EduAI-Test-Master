...
| --- | --- | --- | --- | --- | --- |
| Android 7.0 / API 24 (minima supportata) | N/E — host predisposto con OpenJDK 17, platform-tools/ADB 37.0.1, emulator 37.1.11, platform API 24 e build-tools 36.0.0; l’immagine `system-images;android-24;default;x86_64` non è estraibile per la quota del workspace (`ANDROID-HOST-PREFLIGHT-2026-08-29`, `ANDROID-SYSTEM-IMAGE-QUOTA-2026-08-29`) e la build Gradle resta bloccata sull’NDK non installabile (`ANDROID-NDK-QUOTA-2026-08-29`) | N/E — nessun rifiuto reale del bridge; verificare acquisto conservato, `Riprova` e icona precedente | N/E — nessun rifiuto reale del bridge; verificare `Riprova`, icona precedente e una sola icona custom | N/E — nessun rifiuto reale del bridge; verificare `Riprova`, icona precedente e una sola icona custom | N/E — nessuna build installata né AVD API 24 per confrontare launcher e `icona_futura` equipaggiata |
| Android 16 / API 36 (recente) | N/E — host predisposto con OpenJDK 17, platform-tools/ADB 37.0.1, emulator 37.1.11, platform API 36 e build-tools 36.0.0; l’immagine `system-images;android-36;default;x86_64` non è estraibile per la quota del workspace (`ANDROID-HOST-PREFLIGHT-2026-08-29`, `ANDROID-SYSTEM-IMAGE-QUOTA-2026-08-29`) e la build Gradle resta bloccata sull’NDK non installabile (`ANDROID-NDK-QUOTA-2026-08-29`) | N/E — nessun rifiuto reale del bridge; verificare acquisto conservato, `Riprova` e icona precedente | N/E — nessun rifiuto reale del bridge; verificare `Riprova`, icona precedente e una sola icona custom | N/E — nessun rifiuto reale del bridge; verificare `Riprova`, icona precedente e una sola icona custom | N/E — nessuna build installata né AVD API 36 per confrontare launcher e `icona_futura` equipaggiata |
...
| --- | --- | --- | --- | --- | --- |
| Android | Emulatore | N/E — JDK 17, ADB 37.0.1 ed emulator 37.1.11 disponibili, ma nessuna system image API 24/36 è installabile nella quota del workspace (`ANDROID-HOST-PREFLIGHT-2026-08-29`, `ANDROID-SYSTEM-IMAGE-QUOTA-2026-08-29`) | N/E — nessun rifiuto reale del bridge; manca un AVD installabile | N/E — nessun rifiuto reale del bridge; manca un AVD installabile | N/E — nessuna build/AVD installabile; `/dev/kvm` non disponibile |
| Android | Dispositivo reale | N/E — JDK 17 e ADB 37.0.1 disponibili, ma `adb devices -l` non rileva dispositivi (`ANDROID-HOST-PREFLIGHT-2026-08-29`) | N/E — nessun rifiuto reale del bridge; nessun dispositivo collegato | N/E — nessun rifiuto reale del bridge; nessun dispositivo collegato | N/E — nessuna build installata né dispositivo collegato |
